...
- [ ] Database applied (`Update-Database` / `dotnet ef database update`)
- [ ] Supabase RLS + Data API hardening
- [ ] Seed: Sports, Badges, ReportReasons
- [ ] Auth infrastructure contracts + JWT wiring
- [ ] Storage abstraction
- [ ] API conventions (pagination, Result → HTTP)

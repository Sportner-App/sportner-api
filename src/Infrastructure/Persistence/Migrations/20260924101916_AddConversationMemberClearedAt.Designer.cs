...
namespace Sportner.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260924101916_AddConversationMemberClearedAt")]
    partial class AddConversationMemberClearedAt
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sportner.Domain.Events.Event", b =>
                {
                    ...
                    b.Property<short?>("ParticipantGender")
                        .HasColumnType("smallint");

                    b.Property<Guid?>("SeriesId")
                        .HasColumnType("uuid");

                    b.Property<int?>("SeriesIntervalWeeks")
                        .HasColumnType("integer");

                    b.Property<int?>("SeriesSequence")
                        .HasColumnType("integer");

                    b.Property<int?>("SeriesTotalOccurrences")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("SeriesId", "SeriesSequence");
                    ...
                    b.ToTable("Events", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_Events_ParticipantGender", "\"ParticipantGender\" IS NULL OR \"ParticipantGender\" IN (1, 2)");
                        });
                });
            ...
            modelBuilder.Entity("Sportner.Domain.Locations.City", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Sportner.Domain.Sports.SportCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Sportner.Domain.Users.User", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("PasswordResetSentAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Sportner.Domain.Users.UserExternalLogin", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Sportner.Domain.Sports.Sport", b =>
                {
                    b.HasOne("Sportner.Domain.Sports.SportCategory", null)
                        .WithMany()

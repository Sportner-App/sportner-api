...
internal sealed class ActivateSportCommandHandler
    : ICommandHandler<ActivateSportCommand, SportResponse>
{
    private readonly IApplicationDbContext _dbContext;
    private readonly TimeProvider _timeProvider;

    public ActivateSportCommandHandler(
        ...
        CancellationToken cancellationToken)
    {
        ...
        sport.Activate(_timeProvider.GetUtcNow());

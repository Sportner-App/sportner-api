...
namespace Sportner.Application.Features.Social.Feed.GetExploreFeed;

public sealed record GetExploreFeedQuery(string? Before = null, int Limit = 20)
    : IQuery<CursorPagedResult<PostResponse>>;

internal sealed class GetExploreFeedQueryHandler
    : IQueryHandler<GetExploreFeedQuery, CursorPagedResult<PostResponse>>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var query = _dbContext.Posts.AsNoTracking().Include(post => post.Media).AsQueryable();

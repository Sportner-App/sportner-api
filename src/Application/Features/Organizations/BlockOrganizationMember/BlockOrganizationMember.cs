...
public sealed record BlockOrganizationMemberCommand(Guid OrganizationId, Guid UserId) : ICommand;

internal sealed class BlockOrganizationMemberCommandHandler
    : ICommandHandler<BlockOrganizationMemberCommand>
{
    ...
    public BlockOrganizationMemberCommandHandler(
    ...
    public async Task<Result> Handle(
        BlockOrganizationMemberCommand request,
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            target.Block(_timeProvider.GetUtcNow());
        }
        ...
        await _notificationPublisher.PublishAsync(
            request.UserId,
            NotificationType.OrganizationMemberBlocked,
            title,
            title,

...
namespace Sportner.Application.Features.Moderation.RejectReport;

public sealed record RejectReportCommand(Guid ReportId, string ResolutionNote)
    : ICommand<ReportResponse>;

public sealed class RejectReportCommandValidator : AbstractValidator<RejectReportCommand>
{
...
internal sealed class RejectReportCommandHandler
    : ICommandHandler<RejectReportCommand, ReportResponse>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            report.Reject(moderatorUserId, request.ResolutionNote, utcNow);
        }

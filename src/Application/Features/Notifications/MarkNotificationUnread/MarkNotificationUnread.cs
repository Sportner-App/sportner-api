...
namespace Sportner.Application.Features.Notifications.MarkNotificationUnread;

public sealed record MarkNotificationUnreadCommand(Guid NotificationId) : ICommand;

internal sealed class MarkNotificationUnreadCommandHandler
    : ICommandHandler<MarkNotificationUnreadCommand>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        notification.MarkAsUnread(_timeProvider.GetUtcNow());
